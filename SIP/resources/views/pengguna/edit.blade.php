                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{url('pengguna/create')}}" class="breadcrumb-link">Pengguna Edit</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="post" action="{{route('pengguna.update', $data->id)}}">
                                    	@csrf
                                        @method('PUT')
                                        <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="nama" type="text" required class="form-control" name="nama" value="{{$data->nama}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 col-lg-9">
                                                    <input id="email" type="email" required="" data-parsley-type="email" class="form-control" name="email" value="{{$data->email}}">
                                                    <div class="invalid-feedback">
