...
<div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Edit Santri</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{url('santri/create')}}" class="breadcrumb-link">SantriEdit</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Edit Santri</h5>
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="post" action="{{route('santri.update', $santri->id)}}">
                                    	@csrf
                                        @method('PUT')
                                        <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="nisn" type="text" required class="form-control" name="nisn" value="{{$santri->nisn}}">
                                            ...
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="Nama" type="text" required class="form-control" name="nama" value="{{$santri->nama}}">
                                                	<div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="Tempat_Lahir" type="text" required class="form-control" name="tempat_lahir" value="{{$santri->tempat_lahir}}">
                                                	<div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="Tanggal_Lahir" type="date" required class="form-control" name="tanggal_lahir" value="{{$santri->tanggal_lahir}}">
                                                	<div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-9 col-lg-9">
                                                	<input id="Alamat" type="text" required class="form-control" name="alamat" value="{{$santri->alamat}}">
                                                	<div class="invalid-feedback">
